...
public class Calcultor_practic extends JFrame implements ActionListener {
	String s;
	String left_op;
	String right_op;
	String operator;
	...
	public Calcultor_practic() {
		...
		jp1.setBorder(new TitledBorder("First"));
		jp2.setBorder(new TitledBorder("Second"));
		jp3.setBorder(new TitledBorder("Third"));
	
		
		jtf = new JTextField("122,245");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().equals("Backspace")) {
			...
			try {
				double val = Double.parseDouble(jtf.getText());
				if(val < 0) {
					jtf.setText("Error");
				}else {
					jtf.setText(String.valueOf(Math.sqrt(val)));
					s = "";
				}
			...
			try {
				...
				if(val < 0) {
					...
					jtf.setText(String.valueOf(1.0 / val));
					s = "";
				}
